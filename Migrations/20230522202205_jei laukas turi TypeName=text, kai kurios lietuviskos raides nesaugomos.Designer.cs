...
namespace Bakalauras.Migrations
{
    ...
    [Migration("20230522202205_jei laukas turi TypeName=text, kai kurios lietuviskos raides nesaugomos")]
    partial class jeilaukasturiTypeNametextkaikurioslietuviskosraidesnesaugomos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bakalauras.data.entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bakalauras.data.entities.PaymentUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bakalauras.data.entities.PaymentUser", b =>
                {
                    b.HasOne("Bakalauras.data.entities.Payment", "Payment")
                        .WithMany("PaymentUser")
